...
ارسلها <@${message.author.id}>                                                                                                                         ت�� تعديلها في شات** <#${message.channel.id}>\n\nقبل التعديل:\n \`${message.cleanContent}\`\n\nبعد التعديل:\n \`${newMessage.cleanContent}\``)
       .setTimestamp();
...
❖log ~قم بانشاء روم باسم log للتفعيل لوق خرافي من قبل البوت
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/KnkDC8P**")
